...
# ============================================================
# TYSON TRAINING - SAFE NIGHTWING VERSION
# Based on the working no-CSS version, with safe styling only.
# ============================================================
...
def load_log():
    ...
    # Fix compatibility with older versions of the app that saved "set_number"
...
# SAFE CSS: no fixed overlays, no pseudo elements, no unsafe Streamlit internals.
st.markdown("""
<style>
.block-container {
    padding-top: 1.4rem;
...
/* Safe glowing cards used inside Streamlit expanders */
.nw-exercise-card {
    padding: 12px 13px;
    border-radius: 15px;
...
/* ---------- Dynamic Nightwing blue background ---------- */
.stApp {
    background:
...
section[data-testid="stSidebar"] {
    background:
        linear-gradient(180deg, #020617, #082f49, #020617);
}
...
/* remove red Streamlit focus outlines */
button:focus {
...
<div class="nw-hero">
    ...
    <div class="nw-hero-sub">Tyson Cooke's PPPPLA tracker</div>
    <span class="nw-badge">Bench Strength • V-Taper • Delts • Cardio</span>
</div>
""", unsafe_allow_html=True)

page = st.sidebar.radio("Options", ["Today", "Cardio", "Progress", "Bodyweight", "Routine"])
